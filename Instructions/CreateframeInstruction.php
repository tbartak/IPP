...
class CreateframeInstruction implements IInstruction
{
    ...
    public function __construct(array $args, Interpreter $interpreter)
    {
        ...
        if (count($this->args) !== 0) {
            throw new SourceStructureException("CREATEFRAME instruction has invalid amount of arguments");
        }
    }
    ...
    {
        $this->interpreter->createTemporaryFrame();
    }
}